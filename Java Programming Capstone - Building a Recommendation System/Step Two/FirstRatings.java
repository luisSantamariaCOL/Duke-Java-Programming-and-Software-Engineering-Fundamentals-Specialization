...
public class FirstRatings {
    ...
    public ArrayList<Rater> loadRaters(String filename) {
        ...
        for (CSVRecord record : parser) {
            Rater rater = recordToRater(record);
    ...
    private Rater recordToRater(CSVRecord record) {
    ...
    private void howManyDifferentMoviesHaveBeenRated(ArrayList<Rater> raters) {
        System.out.println("-------------------------------------------------");
    ...
    private void printMaximumNumberOfRatings(int maxNumOfRatings, ArrayList<Rater> raters) {
        int count = 0;
        System.out.println("-------------------------------------------------");
    ...
    private void printNumOfRatingsOfParticularMovie(String movie_id, ArrayList<Rater> raters) {
    ...
    public ArrayList<Movie> loadMovies(String filename) {
        FileResource fileOfRecords = new FileResource("data/" + filename + ".csv");
    ...
    public void testLoadMovies() {
        ...
        ArrayList<Movie> localVariable = loadMovies("ratedmoviesfull");
